...
function pokemonTemplate(pokemon, pokemonInfo) {
  ...
  return `
    <div class="pokemon-card" data-pokemonName="${pokemon.name}">
      <img class="card-img" src="https://img.pokemondb.net/artwork/${pokemon.name}.jpg">
...
function addPokemonToDOM(pokemon) {
  ...
  <div class="pokemon">
  <img class="card-img pokemon-img" src="https://img.pokemondb.net/artwork/${pokemon.name}.jpg">
